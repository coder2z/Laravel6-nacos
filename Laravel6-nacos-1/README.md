...
### Laravel6整合阿里Nacos实现微服务
##### composer update 后需要修改：
     Laravel6-nacos-1\vendor\overlu\laravel-reget\src\Drivers\Nacos.php
     
     90行添加'namespaceId' => $this->service['namespaceId'],
